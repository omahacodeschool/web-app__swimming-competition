...
DB.define_table("sign_up_results")
DB.define_column("sign_up_results", "swimmer_info_id", "integer")
DB.define_column("sign_up_results", "event_id", "integer")
DB.define_column("sign_up_results", "time", "float")
DB.define_column("sign_up_results", "rank", "integer")
