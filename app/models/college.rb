class College < ActiveRecord::Base
  ...
  #
  #
  #Returns a String of the conference name for 1 college.
  # def conference_name 
...
#     ---.college_id
# conference_ids<<u.conference_id #an ARecord Relation of just one conference ID object? have an array with just #1 and #2 from actor ID column)
# end
