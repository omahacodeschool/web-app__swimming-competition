...
class ResultTest < Minitest::Test
  ...
  def test_get_contestant_info
    assert_includes(@score1.contestant.first_name, @contestant1.first_name)
    assert_includes(@score1.contestant.last_name, @contestant1.last_name)
  end

  def test_get_chili_info
    assert_includes(@score1.chili_name, @chili1.name)
  end

  def test_get_competition_info
    assert_includes(@score1.competition, @competition1.name)
  end
